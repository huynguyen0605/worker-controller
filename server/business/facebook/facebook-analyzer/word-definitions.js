...
const allProductMap = {
  ...
  BINH_SUA: {
    'bình sữa tomme tippie': 'https://shope.ee/30QoyWALCS',
  ...
  TI_GIA: {
    'ti Avent': 'https://shope.ee/nDP3tsw9',
...
const promotions = [
  `Thời tiết thay đổi, các mom có con bị ngạt mũi, sổ mũi, bệnh hô hấp thì bôi dầu chàm giữ ấm chân và ngực con sau khi tắm, hút mũi, kết hợp với sử dụng nước muối fysoline để vệ sinh mũi & diệt khuẩn đường hô hấp cho con nhé. Nước muối fys: ${allProductMap.NUOC_MUOI['fys xanh']}`,
  `Các con khi thay đổi thời tiết dễ gặp tình trạng ngạt mũi, sổ mũi, viêm đường hô hấp. Các Mom hãy thường xuyên vệ sinh mũi & sát khuẩn đường hô hấp cho các con bằng nước muối fysoline nhé. ${allProductMap.NUOC_MUOI['fys xanh']}`,
  `Thay đổi thời tiết liên tục các con dễ gặp các bệnh về hô hấp. Các mom nhớ thường xuyên vệ sinh mũi & sát khuẩn đường hô hấp cho con bằng nước muối fysoline nhé. ${allProductMap.NUOC_MUOI['fys xanh']}`,
  `Thời tiết thay đổi liên tục khiến các bé dễ gặp các bệnh đường hô hấp. Các mom hãy phòng tránh bằng cách vệ sinh & sát khuẩn mũi cho con bằng nước muối fysoline nhé. ${allProductMap.NUOC_MUOI['fys xanh']}`,
  `Thời tiết thay đổi khiến các bé dễ gặp các bệnh đường hô hấp. Các mom hãy phòng tránh bằng cách vệ sinh & sát khuẩn mũi cho con bằng nước muối fysoline nhé. ${allProductMap.NUOC_MUOI['fys xanh']}`,
  `Các con hay gặp tình trạng táo bón, lười ăn, bỏ ăn, mom đừng lo lắng. chỉ cần cho con sử dụng men tiêu hóa biogaia là được. ${allProductMap.MEN_TIEU_HOA['Men biogaia']}`,
  `Mom có con gặp tình trạng táo bón, bỏ ăn, lười ăn ngay lập tức cho con sử dụng men tiêu hóa nhé. ${allProductMap.MEN_TIEU_HOA['Men biogaia']}`,
  `Mom có con gặp tình trạng bỏ ăn, lười ăn, táo bón ngay lập tức cho con sử dụng men tiêu hóa nhé. ${allProductMap.MEN_TIEU_HOA['Men biogaia']}`,
  `Khi các con gặp tình trạng chán ăn, lười ăn, táo bón, các mom ngay lập tức cho con sử dụng men tiêu hóa nhé. ${allProductMap.MEN_TIEU_HOA['Men biogaia']}`,
  `Mom muốn con tăng cân, dễ tiêu hóa thì cho con dùng sữa nan ngay nhé. ${allProductMap.SUA['Sữa Nan']}`,
  `Các mom có con khó tăng cân, đang muốn đổi sct cho con thì cho con dùng ngay sữa nan nhé. Dễ tăng cân lại mát. ${allProductMap.SUA['Sữa Nan']}`,
  `Mom nào ít sữa, có thể kết hợp kích sữa bằng máy với sử dụng ngũ cốc lợi sữa là đc ak. ${allProductMap.LOI_SUA['ngũ cốc lợi sữa']}`,
  `Các mom ít sữa, chỉ cần kết hợp kích sữa bằng máy & sử dụng ngũ cốc là sữa về ầm ầm ạ. ${allProductMap.LOI_SUA['ngũ cốc lợi sữa']}`,
  `Các mom muốn gọi sữa về thì sử dụng ngũ cốc là sữa về ầm ầm ngay ạ. ${allProductMap.LOI_SUA['ngũ cốc lợi sữa']}`,
  `Mom ít sữa thì ngay lập tức kết hợp kích sữa bằng máy vs sử dụng ngũ cốc lợi sữa nhé. ${allProductMap.LOI_SUA['ngũ cốc lợi sữa']}`,
  `Mom muốn tăng đề kháng cho con có thể cho con bổ sung d3k2 nhé. ${allProductMap.D3K2['d3k2']}`,
  `Mom nào muốn tăng sức đề kháng cho con thì ngay lập tức cho con bổ sung d3k2 kết hợp thêm sữa non ildong nhé. d3k2: ${allProductMap.D3K2['d3k2']}`,
  `Các mom muốn con tăng đề kháng, phát triển tốt thì chỉ cần cho con bổ sung d3k2 là đc ạ. ${allProductMap.D3K2['d3k2']}`,
];
// const promotions = [
